...
export const ThemeIndustrialTexts = [
  "HEAVY DUTY",
  "INDUSTRIAL",
  "BUILT TO LAST — SINCE 1892"
] as const;

export const ThemeIndustrial = ({ startDelay = 0, texts }: {
  startDelay?: number;
  /** Replaces the on-screen text, slot by slot (see ThemeIndustrialTexts). */
  texts?: readonly string[];
}) => {
  const t = mergeTexts(texts, ThemeIndustrialTexts);
