...
export const ThemeBauhausTexts = [
  "BAUHAUS",
  "FORM FOLLOWS FUNCTION"
] as const;

export const ThemeBauhaus = ({ startDelay = 0, texts }: {
  startDelay?: number;
  /** Replaces the on-screen text, slot by slot (see ThemeBauhausTexts). */
  texts?: readonly string[];
}) => {
  const t = mergeTexts(texts, ThemeBauhausTexts);
