...
export const ThemeGlassmorphismTexts = [
  "GLASSMORPHISM",
  "Frosted Glass",
  "Effect"
] as const;

export const ThemeGlassmorphism = ({ startDelay = 0, texts }: {
  startDelay?: number;
  /** Replaces the on-screen text, slot by slot (see ThemeGlassmorphismTexts). */
  texts?: readonly string[];
}) => {
  const t = mergeTexts(texts, ThemeGlassmorphismTexts);
