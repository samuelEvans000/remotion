...
export const ThemePaperCutTexts = [
  "LAYERED DESIGN",
  "Paper",
  "Cut",
...
export const ThemePaperCut = ({ startDelay = 0, texts }: {
  startDelay?: number;
  /** Replaces the on-screen text, slot by slot (see ThemePaperCutTexts). */
  texts?: readonly string[];
}) => {
  const t = mergeTexts(texts, ThemePaperCutTexts);
