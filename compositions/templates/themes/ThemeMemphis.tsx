...
export const ThemeMemphisTexts = [
  "MEMPHIS",
  "DESIGN GROUP"
] as const;

export const ThemeMemphis = ({ startDelay = 0, texts }: {
  startDelay?: number;
  /** Replaces the on-screen text, slot by slot (see ThemeMemphisTexts). */
  texts?: readonly string[];
}) => {
  const t = mergeTexts(texts, ThemeMemphisTexts);
