...
export const ThemeGeometricAbstractTexts = [
  "ABSTRACT",
  "GEOMETRIC COMPOSITION"
] as const;

export const ThemeGeometricAbstract = ({ startDelay = 0, texts }: {
  startDelay?: number;
  /** Replaces the on-screen text, slot by slot (see ThemeGeometricAbstractTexts). */
  texts?: readonly string[];
}) => {
  const t = mergeTexts(texts, ThemeGeometricAbstractTexts);
