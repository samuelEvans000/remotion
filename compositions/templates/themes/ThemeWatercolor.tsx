...
export const ThemeWatercolorTexts = [
  "HAND PAINTED",
  "Watercolor",
  "Organic textures & soft edges"
] as const;

export const ThemeWatercolor = ({ startDelay = 0, texts }: {
  startDelay?: number;
  /** Replaces the on-screen text, slot by slot (see ThemeWatercolorTexts). */
  texts?: readonly string[];
}) => {
  const t = mergeTexts(texts, ThemeWatercolorTexts);
