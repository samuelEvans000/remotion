...
export const ThemeArtDecoTexts = [
  "THE ROARING",
  "1920",
  "ART DECO STYLE"
] as const;

export const ThemeArtDeco = ({ startDelay = 0, texts }: {
  startDelay?: number;
  /** Replaces the on-screen text, slot by slot (see ThemeArtDecoTexts). */
  texts?: readonly string[];
}) => {
  const t = mergeTexts(texts, ThemeArtDecoTexts);
