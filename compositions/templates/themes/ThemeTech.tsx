...
export const ThemeTech = ({ startDelay = 0, texts }: {
  startDelay?: number;
  /** Replaces the on-screen text, slot by slot (see ThemeTechTexts). */
  texts?: readonly string[];
}) => {
  const t = mergeTexts(texts, ThemeTechTexts);
