...
export const ThemeY2KTexts = [
  "Y2K VIBES",
  "MILLENNIUM AESTHETIC"
] as const;

export const ThemeY2K = ({ startDelay = 0, texts }: {
  startDelay?: number;
  /** Replaces the on-screen text, slot by slot (see ThemeY2KTexts). */
  texts?: readonly string[];
}) => {
  const t = mergeTexts(texts, ThemeY2KTexts);
