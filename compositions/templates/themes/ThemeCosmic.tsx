...
export const ThemeCosmicTexts = [
  "EXPLORE THE",
  "COSMOS",
  "Beyond infinity"
] as const;

export const ThemeCosmic = ({ startDelay = 0, texts }: {
  startDelay?: number;
  /** Replaces the on-screen text, slot by slot (see ThemeCosmicTexts). */
  texts?: readonly string[];
}) => {
  const t = mergeTexts(texts, ThemeCosmicTexts);
