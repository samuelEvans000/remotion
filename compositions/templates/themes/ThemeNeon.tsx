...
export const ThemeNeonTexts = [
  "NEON",
  "LIGHTS"
] as const;

export const ThemeNeon = ({ startDelay = 0, texts }: {
  startDelay?: number;
  /** Replaces the on-screen text, slot by slot (see ThemeNeonTexts). */
  texts?: readonly string[];
}) => {
  const t = mergeTexts(texts, ThemeNeonTexts);
