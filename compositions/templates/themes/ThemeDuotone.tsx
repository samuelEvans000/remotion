...
export const ThemeDuotoneTexts = [
  "DUO",
  "TONE"
] as const;

export const ThemeDuotone = ({ startDelay = 0, texts }: {
  startDelay?: number;
  /** Replaces the on-screen text, slot by slot (see ThemeDuotoneTexts). */
  texts?: readonly string[];
}) => {
  const t = mergeTexts(texts, ThemeDuotoneTexts);
