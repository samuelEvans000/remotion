...
export const Theme3DGlassTexts = [
  "PREMIUM",
  "Glass",
  "Morphism",
  "3D GLASS EFFECT"
...
export const Theme3DGlass = ({ startDelay = 0, texts }: {
  startDelay?: number;
  /** Replaces the on-screen text, slot by slot (see Theme3DGlassTexts). */
  texts?: readonly string[];
}) => {
  const t = mergeTexts(texts, Theme3DGlassTexts);
