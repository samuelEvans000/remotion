...
import { EASE, lerp, font, mergeTexts } from "./common";

/** Default on-screen text slots, in reading order. */
export const ThemeRetroTexts = [
  "★ ESTABLISHED 1985 ★",
  "Vintage",
  "Classic Style Never Dies"
] as const;

export const ThemeRetro = ({ startDelay = 0, texts }: {
  startDelay?: number;
  /** Replaces the on-screen text, slot by slot (see ThemeRetroTexts). */
  texts?: readonly string[];
}) => {
  const t = mergeTexts(texts, ThemeRetroTexts);
