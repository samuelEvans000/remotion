...
export const ThemePopTexts = [
  "POP!"
] as const;

export const ThemePop = ({ startDelay = 0, texts }: {
  startDelay?: number;
  /** Replaces the on-screen text, slot by slot (see ThemePopTexts). */
  texts?: readonly string[];
}) => {
  const t = mergeTexts(texts, ThemePopTexts);
