...
export const ThemeCyberpunkTexts = [
  "CYBER",
  "PUNK"
] as const;

export const ThemeCyberpunk = ({ startDelay: _startDelay = 0, texts }: {
  startDelay?: number;
  /** Replaces the on-screen text, slot by slot (see ThemeCyberpunkTexts). */
  texts?: readonly string[];
}) => {
  const t = mergeTexts(texts, ThemeCyberpunkTexts);
