...
export const NEW_TEMPLATE_ANIMATION_TYPES = [
  ...
  'wave_hello',
  'wave_text',
  // locomotion-templates (countdown_timer and quote_card already existed above)
  'fade_slide_up',
  'spring_scale_in',
  'typewriter_reveal',
  'staggered_words',
  ...
  'sales_card',
  'meme_card',
  // remotion-scenes ThemeAnimations
  'theme_3d_glass',
  'theme_3d_glass_three_js',
  'theme_art_deco',
  'theme_bauhaus',
  'theme_boho',
  'theme_brutalist_web',
